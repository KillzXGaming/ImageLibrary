...
#ifdef _WIN32
#ifdef RG_ETC1_EXPORTS
#define RG_ETC1_API __declspec(dllexport)
#else
#define RG_ETC1_API __declspec(dllimport)
#endif
#else
#define RG_ETC1_API __attribute__((visibility("default")))
#endif
...
namespace rg_etc1
{
   ...
   RG_ETC1_API void pack_etc1_block_init();

   // Pack 4x4 RGBA block → 8-byte ETC1
   RG_ETC1_API unsigned int pack_etc1_block(
       void* pETC1_block,                    // output: 8 bytes
       const unsigned int* pSrc_pixels_rgba, // input: 16 pixels (RGBA)
