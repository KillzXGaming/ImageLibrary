// Ported from https://github.com/richgel999/rg-etc1/blob/master/rg_etc1.cpp
...
extern "C"
{
    RG_ETC1_API unsigned char* pack_etc1_block_alloc(
        ...
        bool dither)
    {
        ...
        rg_etc1::pack_etc1_block(pBlock, pSrc_pixels_rgba, params);

        return pBlock;
    }

    RG_ETC1_API void release_memory(void* ptr)
    {
        delete[] static_cast<unsigned char*>(ptr);
    }

    // Optional: simple C-style version without namespace
    RG_ETC1_API void pack_etc1_block_init_c()
    {
