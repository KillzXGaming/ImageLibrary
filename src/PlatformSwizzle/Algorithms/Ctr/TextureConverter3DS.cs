...
{
    public static class TextureConverter3DS
    {
        ...
        public static byte[] DecodeBuffer(byte[] Input, int Width, int Height, PICATextureFormat Format)
        {
            ...
            {
                return ETC1TextureCompression.Decode(Input, Width, Height, Format == PICATextureFormat.ETC1A4);
            }
            else
            {
        ...
        public static byte[] Encode(Image<Rgba32> Img, PICATextureFormat Format)
        {
            ...
            else
            {
                ...
                if (Format == PICATextureFormat.L4 || Format == PICATextureFormat.LA4 ||
                    Format == PICATextureFormat.A4)
                    return Output;
        ...
        public static int CalculateTotalSize(int width, int height, int mipCount, PICATextureFormat format)
        {
            ...
            for (int level = 0; level < mipCount; level++)
            {
                ...
                size += TextureConverter3DS.CalculateLength(mwidth, mheight, format);
            }
            return size;
        }
