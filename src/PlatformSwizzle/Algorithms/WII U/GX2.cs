...
namespace ImageLibrary.WiiU
{
    public class GX2
    {
        ...
        public class GX2Surface
        {
            ...
            public uint[] mipOffset = new uint[13];
            public byte[] compSel;
            public uint[] texRegs;
            ...
            public void Write(BinaryWriter writer)
            {
                ...
                writer.Write(pitch);
                for (int i = 0; i < mipOffset.Length; i++)
               ...
               uint Width, uint Height, uint Depth, uint Format, uint swizzle, uint SurfaceDim, uint MipCount)
        {
            ...
            surf.mipData = ByteUtil.CombineByteArray(mips.ToArray());
            mips.Clear();
