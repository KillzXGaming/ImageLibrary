...
namespace ImageLibrary
{
    public class ImageEncoders
    {
        ...
        public static ImageEncoder R8Signed() => new Rgba(8) { IsSigned = true, };
        public static ImageEncoder Rg8Signed() => new Rgba(8, 8) { IsSigned = true, };
        public static ImageEncoder Rgba8Signed() => new Rgba(8, 8, 8, 8) { IsSigned = true, };
        public static ImageEncoder R8() => new Rgba(8) { ChannelOrder = "RRR1", };
        ...
        public static ImageEncoder Bc4(bool snorm = false) => new Bcn(BcnFormats.BC4);
        public static ImageEncoder Bc4A(bool snorm = false) => new Bcn(BcnFormats.BC4) { IsAlpha = true };
        public static ImageEncoder Bc5(bool snorm = false) => new Bcn(snorm ? BcnFormats.BC5S : BcnFormats.BC5);
        public static ImageEncoder Bc5A(bool snorm = false) => new Bcn(snorm ? BcnFormats.BC5S : BcnFormats.BC5) { IsAlpha = true };
        public static ImageEncoder Bc6(bool signed = false) => new Bcn(BcnFormats.BC6S);
